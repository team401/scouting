...
import { BarChart3, CalendarDays, Check, ChevronRight, ClipboardList, Cloud, CloudOff, Gauge, LayoutDashboard, LogOut, Minus, Moon, Plus, Radio, Settings, Shield, Sun, TowerControl, UserCog, Users, WandSparkles, Wrench, Zap } from 'lucide-react';
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setPitReady(false); setPitMessage('');
