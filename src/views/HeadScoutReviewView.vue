...
import { headScoutTable, matchScoutTable } from "@/lib/constants";
import { getHeadScoutSchema } from "@/lib/2025/head-scouting-form";
...
<template>
    <div class="main-content">
        <h1>Headscout Match Review</h1>

        <form v-if="formLoaded">
           <FormSection
  v-for="section in scoutForm"
...
export default {
    ...
    methods: {
        async loadScoutForm() {
            ...
            this.scoutForm = await getHeadScoutSchema();
        ...
        async submitForm() {
            ...
            const error = await submitScoutData(this.submitData, headScoutTable);
